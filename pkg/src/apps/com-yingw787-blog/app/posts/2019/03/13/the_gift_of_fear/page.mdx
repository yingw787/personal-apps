...
- **Fear is a gut feeling**: By all means, don't ignore your intuition because
  ...
  should do it. Better to be non-conformist and alive than comformist and dead.
  If somebody is being too nice, be forceful and say no.
...
- **Fear energizes; it does not paralyze**: If you ever find yourself in a
  ...
  robbed. You are kind of just along for the ride. Somehow that evening I slept
  like a baby, because nobody will break into a house that has busted locks and
  no valuables.

- **Fear should be rare**: You shouldn't live in a constant state of anxiety or
  worry, because it dampens the signal of fear when you need it the most and
  cost you everything. If you are feeling anxious or fearful, it is likely

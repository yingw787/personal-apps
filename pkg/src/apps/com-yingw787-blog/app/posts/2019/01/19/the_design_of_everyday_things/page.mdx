...
- **There should be one right way to do your thing**: Norman hammers home the
  ...
  pathways dilutes this conceptual model and hence confuses the user, decreasing
  the utility of the added functionality. Another way to say this is the
  conceptual model of a product should be a tree, with one path to any
  particular action.

- **Weigh the opportunity cost of action vs. inaction**: Einstein famously said
  to make things as simple as possible, but no simpler. Norman echoes the same,
  warning both of creeping featurism and worshipping false images (e.g.
  minimalism) as impediments to great user experience. Creeping featurism may be
  the more prominent issue for corporate products, as the hunger for profit
  demands shipping more features to more customers.

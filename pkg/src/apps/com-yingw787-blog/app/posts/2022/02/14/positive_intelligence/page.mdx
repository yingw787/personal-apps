...
export const article = {
  ...
  description: "Book Review: \"Positive Intelligence: Why Only 20% of Teams and Individuals Achieve Their True Potential, And How You Can Achieve Yours\", by Shirzad Chamine",
  categories: ["Books"],
};

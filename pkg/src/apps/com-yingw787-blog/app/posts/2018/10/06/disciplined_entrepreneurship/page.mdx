...
kernel to customize a checklist to your particular area of business. It also
lists some hard numbers entrepreneurs should respect, for example:

- For Software-as-a-Service (SaaS) business models, the ratio of the lifetime
  value (LTV) of a customer to the cost of customer acquisition (COCA) should be

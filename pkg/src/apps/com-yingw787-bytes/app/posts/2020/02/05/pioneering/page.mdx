...
in the loop to sell themselves (as opposed to say consulting). And I like
process because talking about process leads to investment in a system where
everybody can benefit, which could reduce friction, increase alignment, and
dampen negative human influences.
...
- **Tunnel all the way to the end**: What I wanted to prove out in the proof of
  concept was mere technical feasibility. For me, that required a massive
...
- **Keep momentum up any way you can**: Write specs you know you won't follow.
  ...
  thing to getting this done is to make sure there's no "zero days". As long as
  progress isn't zero, it will take a finite amount of time to finish.
...
[Discussion on
lobste.rs](https://lobste.rs/s/ymnofa/pioneering_as_process_person)

...
- In your `Dockerfile`, add your base Docker image reference, labels, and
...
- In your `Makefile`, create the `run` target. This `run` target is nice
...
- Add various other targets you may need to commonly reference. I templated
